...
# ── Tango ────────────────────────────────────────────────────────────────────
# A two-party equal-output mix. Everything stored here is public or about to be
# on chain: outpoints, x-only public keys, amounts, the derived scriptPubKeys,
# witnesses. No scan key, no spend key, no private tweak — both sides derive on
# their own devices and sign there. See migrations.py::m033.
